...
impl Workspace {
    pub(super) fn inspector(&mut self,cx:&mut Cx2d,b:Box2) {
        ...
        for line in[
            ...
            format!("Source memory: {}",f::bytes(tree.source_memory_bytes as u64)),
        ...
        y+=22.0; self.chrome.text(cx,x,y,9.0,p::muted(),"Actual source at every scale · no view switch"); y+=30.0;
