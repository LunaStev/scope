//! Semantic tokens shared by the map and the compact application shell.
...
pub fn language(name:&str)->Vec4{
    match name {
        "Rust"=>rgb(196,153,124),"C"|"C Header"|"C++"|"C++ Header"=>rgb(129,155,193),
        "Python"=>rgb(188,177,133),"JavaScript"|"JSX"=>rgb(190,178,120),
        "TypeScript"|"TSX"=>rgb(125,161,194),"Go"=>rgb(124,178,185),
        "Java"|"Kotlin"=>rgb(169,150,187),"JSON"|"TOML"|"YAML"=>rgb(136,174,158),
        "Markdown"|"HTML"|"CSS"=>rgb(150,160,185),
